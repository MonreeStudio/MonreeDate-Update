...
namespace 倒计时
{
    ...
    public sealed partial class TimerPage : Page
    {
        ...
        private void TimeEllipse_PointerEntered(object sender, PointerRoutedEventArgs e)
        {
            TimeBackGroundEllipse.Fill = new SolidColorBrush(Colors.LightGray);
        }

        private void TimeEllipse_PointerExited(object sender, PointerRoutedEventArgs e)
        {
            TimeBackGroundEllipse.Fill = new SolidColorBrush(Colors.Transparent);
        }

        private void TimeText_PointerEntered(object sender, PointerRoutedEventArgs e)
        {
            TimeBackGroundEllipse.Fill = new SolidColorBrush(Colors.LightGray);
        }
    }
